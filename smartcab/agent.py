...
class LearningAgent(Agent):
    ...
    def learn(self, state, action, reward):
        ...
        t = self.env.t
        if t > 0:
            Q_hat = self.Q[self.state_previous][self.action_previous]    
            Q_hat = Q_hat + (self.alpha*(self.reward_previous + (self.gamma*self.get_maxQ(state) - Q_hat)))   
            self.Q[self.state_previous][self.action_previous] = Q_hat
